...
gsap.from('.proyecto4', {scrollTrigger: {trigger: '.proyecto4',},x: "+=500px",autoAlpha: 0,duration: 1,delay: 0.5})
gsap.from('.proyecto5', {scrollTrigger: {trigger: '.proyecto5',}, x: "-=500px", autoAlpha: 0, duration: 1, delay: 0.5 })
gsap.from('.proyecto6', {scrollTrigger: { trigger: '.proyecto6', }, x: "+=500px", autoAlpha: 0, duration: 1, delay: 0.5})
